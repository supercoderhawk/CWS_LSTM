...
class RNN_HiddenLayer(object):
    def __init__(self, alpha,
        ...
        if (gate_activation == 'sigmoid'):
            ...
            self.gate_activation = Linear()
        if (cell_activation == 'sigmoid'):
            self.cell_activation = Sigmoid()
        elif (cell_activation == 'tanh'):
            self.cell_activation = Tanh()
        elif (cell_activation == 'relu'):
            self.cell_activation = ReLU()
        elif (cell_activation == 'linear'):
            self.cell_activation = Linear()
        n_hidden = n_out
        self.params = {}
        self.learning_rate = {}
        self.batch_grad = {}
...
class RNN(object):
    ...
    def __init__(self,
        ...
        for n_in, n_out in weight_matrix_sizes:
            self.layers.append(RNN_HiddenLayer(alpha=alpha,
